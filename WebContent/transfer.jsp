...
<body>
 ...
 <div class="container-fluid">
  ...
  <h1>Transfer Money Made Easy</h1>
 ...
 <div class="container col-sm-8">
   ...
   <form class="form-horizontal" method="post">
	...
	<div class="form-group">
	  <label class="control-label col-sm-3" for="transferaccno">Transfer Account No</label>
      <div class="col-sm-6">
        <input type="text" class="form-control" id="transferaccno" placeholder="Enter account no" name="trferaccno" required/>
      </div>
    </div>
	<div class="form-group">
	  <label class="control-label col-sm-3" for="confirmtransferaccno">Confirm Account No</label>
      <div class="col-sm-6">
        <input type="text" class="form-control" id="confirmtransferaccno" placeholder="Enter account no" name="cnfrmtrferaccno" required/>
      </div>
    </div>
