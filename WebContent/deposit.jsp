 ...
 <div class="container col-sm-8">
   ...
   <form class="form-horizontal" method="post">
    ...
    <div class="form-group">
	  <label class="control-label col-sm-3" for="amountdeposit">Amount</label>
      <div class="col-sm-6">
        <input type="text" class="form-control" id="amountdeposit" placeholder="Enter amount" name="amtdeposit" required/>
      </div>
    </div>
	
    <div class="form-group">
      <label class="control-label col-sm-3" for="confirmdeposit">Confirm Amount</label>
      <div class="col-sm-6">          
        <input type="text" class="form-control" id="confirmdeposit" placeholder="Enter confirm amount" name="confrmdeposit" required/>
      </div>
    </div>
	<div class="form-group">        
